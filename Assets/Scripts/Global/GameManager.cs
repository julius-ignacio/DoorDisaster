...
public class GameManager : MonoBehaviour
{
    ...
    public GameObject pauseUI, pauseBtn, resumeBtn, RestartBtn, ExitBtn, blackOverlay, HUD, RestartConfirmationUI;
    ...
    void Update()
    {
        ...
        // Optional: Allow pressing ESC to toggle pause
    ...
    // ✅ FIXED: Call this from the Restart button OnClick
    public void RestartLevelHard()
    {
        ...
        // ✅ ALWAYS reset flags, even if DataManager is null
        ...
        // ✅ Diagnostic check - shows if reset worked
        ...
        Debug.Log("🔁 Hard restart: deleted save, reset ALL flags, reloaded scene.");
    }
    ...
    IEnumerator LoadHubScene()
    {
        ...
        if (overlayGroup == null)
            overlayGroup = blackOverlay.AddComponent<CanvasGroup>();
    ...
    public void SaveGameState()
    {
        ...
        DataManager.Instance.SaveTrialData(trialIndex, mode);

        // Save world objects
        WorldSaveSystem.SaveWorld(trialIndex, mode);

        Debug.Log($"📁 Game saved for Mode {mode} Trial {trialIndex}");
    }
}